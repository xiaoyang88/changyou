        ...
        items:[
            {
                ...
                items: [
...

                    {
                        ...
                        docked: 'top',
                        html:'<div id="jing5_z"> ' +
                        '<div id="top_x"><a href="#mysetting"><div class="left_z"><img class="left1_z" src="public/images/myhome_zxy/back.png" ></div></a>' +
                        '<div class="right_z"><a href="#mysetting"><img class="right1_z" src="public/images/myhome_zxy/setting.png" ></a></div>'+
                        '</div></div>'
